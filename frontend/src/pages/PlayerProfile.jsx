    ...
    return (
        <div style={{ marginBottom: 28 }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10 }}>
                ...
                <StatPill label="Avg"     value={p.battingAverage}  color='var(--text-primary)' />
                <StatPill label="SR"      value={p.strikeRate}   color='var(--text-primary)' />
    ...
    return (
        <div style={{ marginBottom: 28 }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10 }}>
                ...
                <StatPill label="Runs"    value={p.totalRunsConceded} color='var(--text-primary)' />
                <StatPill label="Avg"     value={p.bowlingAverage}    color='var(--text-primary)' />
                <StatPill label="Eco"     value={p.economy}           color='var(--text-primary)' />
            </div>
        </div>
    )
}
                        ...
                        {log.map((m, i) => (
                            ...
                            >
                                ...
                                <td style={{ padding: '10px 14px', textAlign: 'center', fontFamily: "'Bebas Neue',sans-serif", fontSize: 20,
                                    color: m.runs >= 50 ? '#f97316' : m.runs >= 30 ? '#22c55e' : 'var(--text-primary)' }}>
                                    {m.runs ?? '—'}
                                </td>
                        ...
                        {log.filter(m => m.oversBowled != null || m.wickets != null).map((m, i) => (
                            ...
                            >
                                ...
                                <td style={{ padding: '10px 14px', textAlign: 'center',
                                    ...
                                    color: m.wickets >= 3 ? '#8b5cf6' : 'var(--text-primary)' }}>
                                    {m.wickets ?? '—'}
                                </td>
...
export default function PlayerProfile({ playerId, onBack, onOpenTeam }) {
    ...
    return (
        <div className="fade-up">
                        ...
                        <div style={{ position: 'relative', display: 'inline-block' }}>
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    background: team.color, border: '2px solid var(--bg-elevated)',
                                    display: 'flex', alignItems: 'center', justifyContent: 'center',
            ...
            {/* Career stats */}
            <div style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)', borderRadius: 16, padding: '24px 28px', marginBottom: 20 }}>
            ...
            {/* Match log */}
            <div style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)', borderRadius: 16, padding: '24px 28px' }}>
