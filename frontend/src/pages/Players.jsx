...
import { Plane, Search, X, Plus } from 'lucide-react'
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
          <div style={{
            ...
            fontSize: 'var(--text-md)', letterSpacing: 1, color: '#f97316',
          }}>
            Add Player
          </div>
      ...
      <div style={{ padding: '20px 14px 10px', width: '100%', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          {isoCode ? (
            ...
            <span style={{
              fontFamily: 'var(--font-body)',
              fontSize: 'var(--text-sm)', color: 'var(--text-muted)', fontWeight: 700,
            }}>
    ...
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: 20, flexWrap: 'wrap', gap: 12 }}>
        <div>
          <div style={{
            fontFamily: 'var(--font-heading)',
            fontSize: 'var(--text-lg)', letterSpacing: 2, color: 'var(--text-primary)', lineHeight: 1,
          }}>
            Player Registry
          </div>
          <div style={{
      ...
      <div style={{ marginBottom: 16, display: 'flex', flexDirection: 'column', gap: 10 }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          <div style={{ flex: 1, position: 'relative' }}>
            <span style={{
              ...
              pointerEvents: 'none', opacity: 0.45, display: 'flex',
        ...
        <div style={{ display: 'flex', gap: 6, overflowX: 'auto', paddingBottom: 2 }}>
          <button
            ...
            style={{
              ...
              outline: filterTeam === 'ALL' ? 'none' : '1px solid var(--border-subtle)',
          ...
          >
            ...
            <span style={{
              fontFamily: 'var(--font-body)',
              fontSize: 'var(--text-sm)', fontWeight: 700, borderRadius: 8, padding: '1px 5px',
        ...
        {/* Role multi-select + origin filter */}
        <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          {[
            { key: 'ALL',      label: 'All',      count: players.length, icon: null },
            { key: 'INDIAN',   label: 'Indian',   count: indianTotal,    icon: null },
            { key: 'OVERSEAS', label: 'Overseas', count: overseasTotal,  icon: <Plane size={12} strokeWidth={2} /> },
          ].map(opt => {
      ...
      {!loading && players.length === 0 && (
        <div style={{ padding: '40px 20px', textAlign: 'center', color: 'var(--text-secondary)' }}>
          ...
          <div style={{
            fontFamily: 'var(--font-body)',
            fontSize: 'var(--text-base)',
          }}>Click "Add Player" to build your squads</div>
        </div>
      )}
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 14 }}>
              ...
              <div>
                <div style={{
                  fontFamily: 'var(--font-heading)',
                  fontSize: 'var(--text-md)', letterSpacing: 1.5,
                  color: team.color, lineHeight: 1,
                }}>{team.name}</div>
                <div style={{
                  fontFamily: 'var(--font-body)',
      ...
      {!loading && players.length > 0 && filtered.length === 0 && (
        <div style={{ padding: '40px 20px', textAlign: 'center', color: 'var(--text-secondary)' }}>
          ...
          <div style={{
            fontFamily: 'var(--font-heading)',
            fontSize: 'var(--text-md)', fontWeight: 600, marginBottom: 4, color: 'var(--text-primary)',
          }}>No players match your filters</div>
          <div style={{
            fontFamily: 'var(--font-body)',
