    ...
    <header style={{
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <div style={{ background: 'linear-gradient(135deg,#f97316,#dc2626)', borderRadius: 10, width: 38, height: 38, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20 }}>
            🏏
          </div>
          <div>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <Button variant={view === 'dashboard' ? 'active' : 'inactive'} onClick={() => setView('dashboard')}>
            📊 Dashboard
          </Button>
          <Button variant={view === 'matches' ? 'active' : 'inactive'} onClick={() => setView('matches')}>
            📋 Matches
          </Button>
